...
/// monthly calendar initially in the dialog shown by calling [showModDatePicker].
///
/// See also:
///
///  * [showModDatePicker], which shows a dialog that contains a material design
///    date picker.
enum DatePickerMode {
...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle =
        headerTextTheme.display1.copyWith(color: dayColor, height: .9);
...
/// [showModDatePicker], which creates a date picker dialog.
///
/// See also:
///
///  * [showModDatePicker], which shows a dialog that contains a material design
...
class DayPicker extends StatelessWidget {
  ...
  ///
  /// This code consolidates the travending:
  ///
...
///    a year.
Future<DateTime> showModDatePicker({
